...
/** include files **/
#include "AccessControlType.h"           // base header
...
/*******************************************************************
* Function Name: AccessControlType
* Description: constructor
********************************************************************/
AccessControlType::AccessControlType( const string &name )
: Atomic( name )
...
********************************************************************/
Model &AccessControlType::initFunction()
{
...
********************************************************************/
Model &AccessControlType::externalFunction( const ExternalMessage &msg )
{
...
********************************************************************/
Model &AccessControlType::internalFunction( const InternalMessage & )
{
...
********************************************************************/
Model &AccessControlType::outputFunction( const InternalMessage &msg )
{
