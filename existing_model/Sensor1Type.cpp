...
/** include files **/
#include "Sensor1Type.h"           // base header
...
/*******************************************************************
* Function Name: Sensor1Type
* Description: constructor
********************************************************************/
Sensor1Type::Sensor1Type( const string &name )
: Atomic( name )
...
********************************************************************/
Model &Sensor1Type::initFunction()
{
...
********************************************************************/
Model &Sensor1Type::externalFunction( const ExternalMessage &msg )
{
...
********************************************************************/
Model &Sensor1Type::internalFunction( const InternalMessage & )
{
...
********************************************************************/
Model &Sensor1Type::outputFunction( const InternalMessage &msg )
{
